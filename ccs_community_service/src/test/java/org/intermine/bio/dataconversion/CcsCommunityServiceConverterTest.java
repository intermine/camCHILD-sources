...
public class CcsCommunityServiceConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    CcsCommunityServiceConverter converter;
    MockItemWriter itemWriter;

    public CcsCommunityServiceConverterTest(String arg) {
        super(arg);
    }
